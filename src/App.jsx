    ...
    <div>
        ...
        <div style={{ padding: "20px" }}>
          ...
          <div style={{ display: "flex", flexWrap: "wrap", gap: "10px" }}>
            {Object.keys(players).map(p => (
              <button key={p} onClick={() => vote(p)} disabled={players[name]?.vote === p} style={{ padding: "10px", borderRadius: "5px" }}>
                Vote {p}
              </button>
            ))}
          </div>
      ...
      {phase === "reveal" && (
        <div style={{ padding: "20px" }}>
          ...
          {name === creator && (
            <button onClick={startRound} style={{ padding: "10px", borderRadius: "5px", cursor: "pointer", marginTop: "10px" }}>
              Next Round
            </button>
          )}
        </div>
